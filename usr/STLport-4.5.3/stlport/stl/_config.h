 ...
 *
 */
/* SN-Dave: Specific behavior forced for PS2
 */
...
// SN-Dave: force _STLP_IMPORT_VENDOR_CSTD for PS2 targets
#  if defined (_STLP_USE_NAMESPACES) && /* ! defined (_STLP_OWN_IOSTREAMS) && */ \
   ( defined(_STLP_USE_OWN_NAMESPACE) || defined (_STLP_VENDOR_GLOBAL_CSTD)) && !defined (__STL_TARGET_PS2)
