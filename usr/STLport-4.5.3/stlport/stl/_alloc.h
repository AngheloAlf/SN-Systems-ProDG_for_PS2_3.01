...
/* SN-Dave: Memory alignment changed for PS2-EE target
 */
...
//SN-Dave: alignment changed to 16 byte aligned for PS2 EE target only.
# if defined(__OS400__) || defined(__STL_TARGET_PS2) && !defined(__STL_TARGET_PS2_IOP)
