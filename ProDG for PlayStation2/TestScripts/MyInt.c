...
// ADB: MyInt.c
//
// An example of the two ways to use scripts to setup custom type handlers
// The selected types will be displayed using custom display templates
// This works for watch and locals panes as well as "floating" tooltip displays
//
...
//
// This script function will be the new display handler for type "int"
// Not that anyone would ever want to display their ints Nibble-Reversed
// but you can see that just about anything is possible.
// This functionc ould also use all the other script builtin functions
