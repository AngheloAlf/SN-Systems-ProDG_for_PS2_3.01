...
// This example hooks the SM_TARGETATN message that happens when the target changes state
// eg. if the target starts or stops executing code eg. if it hits a breakpoint.
//
