//
// This is one way to hook the "Edit Here" function of the source pane
...
// the debugegr will attempt to launch an external editor:-
//
// If this script function exists then it will be called to invoke the editor
// else if the [opentemplate] string is set in the debugger config it will use that
// else it will try to use COM to talk to MS Developer Studio to edit the file.
//
// This simple example is for CodeWright and is just the script equivalent of having
...
// those lines to your default config (will be used if no local config is present)
...
//
// if it is to match the debugegr requirements. Otherwise errors will be displayed
